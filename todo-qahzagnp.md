...
- [x] 在瀏覽器實際點擊已登入頭像，開啟登出確認彈窗並完成視覺／DOM 驗證
- [x] 儲存包含登出確認彈窗的新 checkpoint 並確認取得新版本 ID（f9d09356）
- [x] 部署後驗證取消不登出、確認才登出的正式流程
- [x] 讓整個已登入資訊框（頭像、姓名、外框與留白）都能開啟登出確認彈窗
- [x] 放大登出彈窗並改善內容寬度、內距、按鈕尺寸與文字可讀性
- [x] 優化彈窗在手機寬度、鍵盤焦點與觸控操作下的舒適度
- [x] 補充整體登入框點擊與 Dialog 互動測試
- [x] 執行完整測試、桌面／手機視覺驗證
- [x] 儲存 checkpoint 並部署舒適度優化版本
- [ ] 在最新舒適度版本完成桌面與手機實際視覺驗證
- [ ] 儲存包含整體登入框可點與放大彈窗調整的新 checkpoint 並部署
